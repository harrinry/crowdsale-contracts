...
var contractLocationsPath = 'contract-locations.json'
...
fs.readdir(contractsPath, function (err, items) {
  ...
  var contractLocationData = fs.readFileSync(contractLocationsPath).toString()
  bundle += `"ContractLocations": ${contractLocationData},`
